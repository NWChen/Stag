...
def get_control_points(a, b, c, scaling_factor):
	d1 = math.sqrt(float(math.pow(b.x-a.x, 2)+math.pow(b.y-a.y, 2)))
	d2 = math.sqrt(float(math.pow(c.x-b.x, 2)+math.pow(c.y-b.y, 2)))
...
a, b, c, d = Point(320, 360), Point(330, 264), Point(450, 600), Point(600, 600)
build_point(a, 'red', 3)
build_point(b, 'red', 3)
build_point(c, 'red', 3)
build_point(d, 'red', 3)
